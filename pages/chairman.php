...
<div class="message-layout">
    ...
    <div class="message-content">
        ...
        <p>Education is the foundation upon which we build our future. At <?php echo SITE_NAME; ?>, we are committed to providing an environment that fosters intellectual growth, character development, and social responsibility.</p>
        <p>Our vision is to create a learning community where every student is valued, challenged, and inspired to reach their full potential. We believe in holistic education that goes beyond textbooks.</p>
        <p>We strive to create an atmosphere where students develop not just academic skills, but also the values and character traits that will serve them throughout their lives.</p>
        <p class="signature">Chairman<br><?php echo SITE_NAME; ?></p>
    </div>
</div>
</div>
