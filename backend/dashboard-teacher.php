...
$user_name = $_SESSION['user_name'] ?? 'Teacher';
...
<head>
    ...
    <title>Teacher Dashboard - AARUSHI VIDYA NIKETAN</title>
    ...
    <div class="dashboard-container">
        <aside class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li><a href="#"><i class="fas fa-book"></i> My Classes</a></li>
        ...
        <main class="main-content">
            <div class="dashboard-header">
                ...
                <div class="user-info">
                    ...
                    <div>
                        ...
                        <p style="font-size: 0.85rem; color: var(--gray-500);">Teacher</p>
                    </div>
            ...
            <div style="background: var(--white); padding: 30px; border-radius: 15px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
                ...
                <p style="color: var(--gray-600); line-height: 1.6;">
                    This is your teacher dashboard. You can manage your students, classes, assignments, attendance, and view results here.
