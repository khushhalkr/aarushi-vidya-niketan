...
<head>
    ...
    <title>Admin Dashboard - AARUSHI VIDYA NIKETAN</title>
        ...
        <main class="main-content">
            <div class="dashboard-header">
                ...
                <div class="user-info">
                    ...
                    <div>
                        ...
                        <p style="font-size: 0.85rem; color: var(--gray-500);">Administrator</p>
                    </div>
            ...
            <div style="background: var(--white); padding: 30px; border-radius: 15px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
                ...
                <p style="color: var(--gray-600); line-height: 1.6;">
                    This is your administrative dashboard. You can manage students, teachers, classes, attendance, and generate reports from here.
